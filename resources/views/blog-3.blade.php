        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <h2 class="page-title">Blog 03</h2>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        <div class="thumb">
                            <img class="border-radius-5" src="assets/img/blog/7.png" alt="img">
                            <p class="date">31 December,2022</p>
                        </div>
                        <div class="details">
                            <ul class="blog-meta p-0">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        <div class="thumb">
                            <img class="border-radius-5" src="assets/img/blog/8.png" alt="img">
                            <p class="date">31 November,2022</p>
                        </div>
                        <div class="details">
                            <ul class="blog-meta p-0">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        <div class="thumb">
                            <img class="border-radius-5" src="assets/img/blog/9.png" alt="img">
                            <p class="date">31 December,2022</p>
                        </div>
                        <div class="details">
                            <ul class="blog-meta p-0">
