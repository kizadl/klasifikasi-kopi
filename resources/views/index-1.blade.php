...
<body>
    ...
    <!-- page title start -->
    <div class="banner-area bg-relative banner-area-1 pd-bottom-100 bg-cover" style="background-image: url('./assets/img/banner/0.png');">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-5 col-md-8 offset-xl-2 offset-lg-1">
                    <div class="banner-thumb mt-5 mt-lg-0 ms-4 ms-lg-0 wow animated fadeInRight" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        ...
                        <img class="banner-animate-img banner-animate-img-3 left_image_bounce" src="assets/img/banner/4.svg" alt="img">
    ...
    <div class="pricing-area bg-gray pd-top-120 pd-bottom-90">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-pricing-inner style-3">
                        ...
                        <a class="btn btn-black border-radius border-radius-0 w-100" href="#">Started</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-pricing-inner style-3 price-active">
                        <h2 class="mb-3">$19 <sub>/mo</sub></h2>
                        <h5>Started</h5>
                        <ul>
                            <li><i class="fa fa-check"></i>Mobile App Development</li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        ...
                        <div class="details">
                            <p class="date mb-3"><i class="far fa-calendar-alt"></i>October 19, 2023</p>
                            <h5><a href="blog-details.html">Transforming businesses, one pixel at a time</a></h5>
                            <div class="meta">
                                <div class="row">
                                    <div class="col-6">
                                        <p><i class="far fa-user"></i>Sam Curren</p>
                                    </div>
                                    <div class="col-6 text-end">
                                        <p><i class="far fa-comments"></i>Sam Curren</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        ...
                        <div class="details">
                            <p class="date mb-3"><i class="far fa-calendar-alt"></i>June 19, 2023</p>
                            <h5><a href="blog-details.html">The Importance of a Strong Digital for Strategy</a></h5>
                            <div class="meta">
                                <div class="row">
                                    <div class="col-6">
                                        <p><i class="far fa-user"></i>Sam Curren</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        ...
                        <div class="details">
                            <p class="date mb-3"><i class="far fa-calendar-alt"></i>October 19, 2023</p>
                            <h5><a href="blog-details.html">Creating Engaging Content: A Guide for Digital</a></h5>
                            <div class="meta">
                                <div class="row">
                                    <div class="col-6">
                                        <p><i class="far fa-user"></i>Sam Curren</p>
