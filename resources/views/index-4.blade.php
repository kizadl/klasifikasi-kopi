...
<body>
    ...
    <div class="banner-area bg-relative banner-area-3">
        <div class="container custom-container">
            <div class="bg-gray">
                <img class="img-right" src="assets/img/banner-4/1.png" alt="img">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 align-self-center">
                            <div class="banner-inner">
                                ...
                                <h2 class="title wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">Innovative Solutions For A <span>Digital</span> World</h2>
                                <a class="mt-3 btn btn-border-base wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.6s" href="about.html">Discover More <i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pd-top-120">
                <div class="col-xl-7 col-lg-6 col-md-8 order-lg-last">
                    <div class="about-thumb-inner video-thumb">
                        ...
                        <a class="video-play-btn-hover" href="https://www.youtube.com/embed/Wimkqo8gDZ0"><img src="assets/img/video.svg" alt="img"></a> 
                    </div>
                </div>
