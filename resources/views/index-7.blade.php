...
<body>
    ...
    <div class="navbar-area-wrap navbar-area-4">
        <img class="left-bg" src="assets/img/bg/17.png" alt="img">
        <div class="row">
            ...
            <div class="col-9">
                <div class="navbar-top pe-3">
                    <div class="row">
                        <div class="col-lg-8">
                            <ul>
                                <li><i class="fa fa-phone"></i> (629) 555-0129</li>
                                <li><i class="fa fa-envelope"></i> info@example.com</li>
                                <li><i class="fa fa-map-marker-alt"></i> 6391 Elgin St, 10299</li>
                            </ul>
                        </div>
                ...
                <nav class="navbar navbar-area navbar-area-2 navbar-expand-lg bg-white">
                    <div class="container nav-container custom-container ps-lg-0">
                        ...
                        <div class="nav-right-part nav-right-part-desktop d-lg-inline-flex align-item-center">
                            <a class="btn btn-base" href="about.html">Explore Now</a>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <!-- page title start -->
    <div class="banner-area bg-relative banner-area-2 bg-cover mt-0" style="background-image: url('./assets/img/banner-6/1.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 pb-xl-5 align-self-center">
                    <div class="banner-inner pe-xl-4 pb-5">
                        <h6 class="bg-none text-white wow animated fadeInLeft mb-4" data-wow-duration="1.5s" data-wow-delay="0.3s">Protecting your data</h6>
                        <h2 class="title text-white wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">Data Security is Our Top Priority</h2>
                        <p class="content pe-xl-4 wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">Lorem is Ipsum is simply design designer best isthe text Lorem Ipsum this the is simply is our com best ourbe designer Lorem</p>
                        <a class="btn btn-base wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.6s" href="about.html">Explore now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <img class="main-img m-md-4" src="assets/img/about/32.png" alt="img">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center wow animated fadeInRight" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div class="section-title mt-5 mt-lg-0 mb-0 ps-lg-4">
                        <h6 class="bg-none color-base mb-3">ABOUT US</h6>
                        <h2 class="title">Preventing Cyber Attacks Before They Happen</h2>
                        <p class="content mb-4">Preventing Ipsum is simply dummy text of the printing and typesetting industry Loreaim Ipsum has been the industry's standard dummy</p>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <p class="mt-4 mb-4"><strong>Cyber dummy text of the printing and industry Loreaim</strong></p> 
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-8">
                    <div class="section-title text-center">
                        <h6 class="bg-none color-base mb-3">Our Best service</h6>
                        <h2 class="title">Protecting Your Data, One Byte At A Time</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-inner style-3">
                        <div class="thumb-img text-end">
                            <img src="assets/img/home-6/1.png" alt="img">
                        </div>
                        <div class="details">
                            <h5><a href="service-details.html">Network Security</a></h5>
                            <p class="mb-0">You can access SaaS applications through a web browser or mobile app, as long as you have an internet connection</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-inner style-3">
                        ...
                        <div class="details">
                            <h5><a href="service-details.html">Data Encryption</a></h5>
                            <p class="mb-0">You can access SaaS applications through a web browser or mobile app, as long as you have an internet connection</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-inner style-3">
                        ...
                        <div class="details">
                            <h5><a href="service-details.html">Malware Removal</a></h5>
                            <p class="mb-0">You can access SaaS applications through a web browser or mobile app, as long as you have an internet connection</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-inner style-3">
                        ...
                        <div class="details">
                            <h5><a href="service-details.html">Web Security</a></h5>
                            <p class="mb-0">You can access SaaS applications through a web browser or mobile app, as long as you have an internet connection</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-inner style-3">
                        ...
                        <div class="details">
                            <h5><a href="service-details.html">Email Security</a></h5>
                            <p class="mb-0">You can access SaaS applications through a web browser or mobile app, as long as you have an internet connection</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- gallery area start -->
    <div class="gallery-area bg-relative pd-top-120 pd-bottom-90" style="background-image: url('./assets/img/bg/15.png');">
        <div class="container pd-top-120">
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-title style-white">
                        <h6 class="bg-none color-base">Best gallery</h6>
                        <h2 class="title">Securing Your Company Online Presence</h2>
                    </div>
                </div>
            </div>
            <div class="team-slider owl-carousel slider-control-round slider-control-right-top">
                <div class="item">
                    <div class="single-project-inner style-2">
                        <img src="assets/img/gallery/1.png" alt="img">
                        <div class="details">
                            <span><i class="fa fa-plus"></i></span>
                            <a class="read-more-text" href="#">Vegas It Park</a>
                            <p>Lorem is Ipsum is simply is design designer isthe text Lorem Ipsum </p>
                        </div>
                    </div>
                </div>
                <div class="item">
    ...
    <!-- counter area start -->
    <div class="counter-area bg-relative bg-cover pd-top-110 pd-bottom-100" style="background-image: url('./assets/img/home-6/12.png');">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div class="single-counter-inner">
                        ...
                        <p class="text-white">Complete project</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    <div class="single-counter-inner">
                        ...
                        <h2 class="text-white mt-4 mb-2"><span class="counter">200</span>+</h2>
                        <p class="text-white">Client review</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="contact-inner-1">
                <div class="row">
                    <div class="col-lg-8 wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <img class="w-100" src="assets/img/home-6/11.png" alt="img">
                    </div>
                    <div class="col-lg-4 wow animated fadeInRight" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <div class="section-title mb-0">
                            <h6 class="bg-none color-base mb-3">GET IN TOUCH</h6>
                            <h2 class="title">Simple Touch here?</h2>
                            ...
                            <form class="mt-4">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <a class="btn btn-base mt-0 w-100 border-radius-5" href="#">Submit now</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <div class="work-process-area pd-top-120 pd-bottom-120">
        <div class="container">
            <div class="section-title text-center pb-5">
                <h6 class="color-base mb-3 bg-none">Work Process</h6>
                <h2 class="title">Defend Your Business Digital World</h2>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-work-process-inner-4 text-center">
                        <h5>Secure Net</h5>
                        <div class="thumb">
    ...
    <!-- team area start -->
    <div class="team-area bg-relative pd-top-115 pd-bottom-100" style="background-image: url('./assets/img/home-6/17.png');">
        <div class="container">
            <div class="section-title text-center style-white">
                <h6 class="text-white mb-3 bg-none">Dedicated team</h6>
                <h2 class="title">Data Security is Our Top Priority</h2>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-team-inner style-3 text-center">
                        <div class="thumb">
            ...
            <div class="section-title">
                <div class="row">
                    <div class="col-xl-4 col-lg-8">
                        <h6 class="color-base">Latest News</h6>
                        <h2 class="title">Data Security is Our Top Priority</h2>
                    </div>
                    <div class="col-xl-8 text-lg-end align-self-end">
                        <a class="btn btn-base" href="#">Explore More</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        ...
                        <div class="thumb">
                            ...
                            <a class="date-2" href="#">11May,2023</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        <div class="details">
                            ...
                            <h5 class="mb-3"><a href="blog-details.html">One Pixel At a time Transforming businesses</a></h5>
                            <p>Melbourne is simply is dumiomy is text Lorem Ipsum is simply</p>
                        </div>
                        <div class="thumb">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-list">
                        <div class="details">
                            ...
                            <h5 class="mb-3"><a href="blog-details.html">Melbourne businesses, one pixel at a time simply</a></h5>
                            <p>Melbourne is simply is dumiomy is text Lorem Ipsum is simply</p>
                        </div>
                        <div class="thumb">
    ...
    <!-- footer area start -->
    <footer class="footer-area bg-black mt-0">
        <div class="container">
            <div class="footer-top-2 bg-base p-5 border-radius-bottom-20">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="text-white">Contacts Info</h5>
                                <p class="text-white mb-0">willie.jennings@example.com</p>
                                <p class="text-white mb-0">willie.jennings@example.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="text-white">Opening Hour</h5>
                                <p class="text-white mb-0">Mon-Fri: 9:30AM - 6:30PM</p>
                                <p class="text-white mb-0">Sat-Sun: 1:30AM - 3:30PM</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="text-white">Contacts Info</h5>
                                <p class="text-white mb-0">2715 Ash Dr. San Jose, South <br> Dakota 83475</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pd-top-100">
                    ...
                    <div class="widget widget_about">
                        ...
                        <div class="details">
                            ...
                            <div class="subscribe mt-4">
                                <input class="pe-2 border-radius-0" type="text" placeholder="E-mail">
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget widget_nav_menu ps-xl-5">
                        <h4 class="widget-title">All LINKS</h4>
                        <ul>
        ...
        <div class="footer-bottom bg-base">
            <div class="container">
                <div class="row">
