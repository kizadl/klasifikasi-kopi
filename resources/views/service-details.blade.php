                ...
                <div class="col-lg-4 col-12">
                    <div class="td-sidebar service-sidebar">
                        <div class="widget widget_catagory">
                            <h5 class="widget-title"><i class="fas fa-arrow-right"></i> All Service lists</h5>               
                            <ul class="catagory-items">
                                <li><a href="service-details.html"> Planning Department</a></li>
                                <li><a href="service-details.html"> Software Department</a></li>
                                <li><a href="service-details.html"> Hardware Department</a></li>
                                <li><a href="service-details.html"> It Department</a></li>
                                <li><a href="service-details.html"> Others Development</a></li>
                            </ul>
                        </div>
                        <div class="widget widget_author text-center">  
                            ...
                            <div class="details">
                                <a class="btn btn-base border-radius-5" href="#">Discover our company +</a>
                            </div>
                        </div> 
                    ...
                    <div class="blog-details-page-content">
                        <div class="single-blog-inner mb-0">
                            ...
                            <div class="details">
                                ...
                                <p>Thooiie point the of using the table.Your Startup industry is ours standard our service decesion loream saum solar sysem in the world.</p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="single-list-inner style-check style-check mb-3">
                                            <li><i class="far fa-check-circle"></i> Creating a Balanced and Nutritious</li>
                                            <li><i class="far fa-check-circle"></i> iTechnology that helps grow companies</li>
                                            <li><i class="far fa-check-circle"></i> Everything you need to succeed</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="single-list-inner style-check style-check mb-3">
